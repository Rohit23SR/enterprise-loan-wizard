...
export class FinancialDetails implements OnInit, OnDestroy {
  ...
  loanTerms = ['12 months', '24 months', '36 months', '48 months', '60 months']
  ...
  private initializeForm(): void {
    this.financialForm = this.fb.group({
      loanAmount: [null, [Validators.required, Validators.min(MIN_LOAN_AMOUNT)]],
  ...
  private setupFormSubscription(): void {
    this.financialForm.valueChanges.pipe(takeUntil(this.destroy$)).subscribe((values) => {
